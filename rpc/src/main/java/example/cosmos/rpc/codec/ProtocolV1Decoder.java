 ...
 */
package example.cosmos.rpc.codec;

import example.cosmos.rpc.ProtocolConstants;
import example.cosmos.rpc.RpcMessage;
import example.cosmos.rpc.compressor.Compressor;
import example.cosmos.rpc.compressor.CompressorFactory;
import example.cosmos.rpc.exception.DecodeException;
import example.cosmos.rpc.protocol.HeartbeatMessage;
import example.cosmos.rpc.serializer.HessianSerializer;
import example.cosmos.rpc.serializer.Serializer;
import example.cosmos.rpc.serializer.SerializerType;
    ...
    public Object decodeFrame(ByteBuf frame) {
        ...
        if (messageType == ProtocolConstants.MSGTYPE_HEARTBEAT_REQUEST) {
            ...
            if (bodyLength > 0) {
                ...
                Serializer serializer = HessianSerializer.getSerializer();
